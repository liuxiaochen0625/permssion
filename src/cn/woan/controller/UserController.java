...
import cn.woan.pageModel.SessionInfo;
import cn.woan.pageModel.User;
import cn.woan.service.UserServiceI;
import cn.woan.util.IpUtil;
import cn.woan.util.Page;
import cn.woan.util.ResourceUtil;
...
public class UserController {
	...
	@RequestMapping("/list")
	public String list(@RequestParam(required = false) Integer pageNum, Model model, HttpServletRequest request) {
		Page<User> page= new Page<User>();
		model.addAttribute("value", page);
